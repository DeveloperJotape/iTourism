...
<body>
				...
				<div class="collapse navbar-collapse" id="conteudoNavbarSuportado">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item"><a class="nav-link"
							href="pages/Sobre.jsp">Sobre</a></li>
						<li class="nav-item"><a class="nav-link"
							href="pages/Contato.jsp">Contato</a></li>
						<li class="nav-item"><a class="nav-link"
							href="pages/Entrar.jsp">Entrar</a></li>
						<button class="btn-cadastrar"
							onclick="location.href='pages/Cadastrar.jsp';">Cadastrar</button>
					</ul>
				</div>
			</div>
		</nav>
			...
			<div class="row">
				...
				<div class="col-12 col-md-4">
					<div class="card text-center">
						...
						<div class="card-body">
							<h6 class="card-title">Melhores viagens</h6>
							<p class="card-text">Conte as melhores histórias junto da sua
								família!</p>
							<p>
				...
				<div class="col-12 col-md-4">
					<div class="card text-center">
						...
						<div class="card-body">
							<h6 class="card-title">Trilhas pensadas</h6>
							<p class="card-text">Trilhas para toda a família e para
								aventureiros.</p>
							<p>
								<a href="" class="btn-dark">Saiba mais</a>
							</p>
				...
				<div class="col-12 col-md-4">
					<div class="card text-center">
						...
						<div class="card-body">
							<h6 class="card-title">Hospedagens</h6>
							<p class="card-text">
								Mais conforto, menor preço. <br>Para toda família.
							</p>
							<p>
								<a href="" class="btn-dark">Saiba mais</a>
							</p>
	...
	<div class="container" id="featured-container">
		<div class="col-12">
			...
			<p class="subtitle secondary-color">Conheça as melhores paradas
				para este inverno</p>
		</div>
		...
		<div class="col-12" id="featured-images">
			...
			<div class="justify-content-center d-flex">
				<p>
					<a href="" class="btn-dark">Ver mais</a>
				</p>
			</div>
		</div>
	</div>
	...
	<!-- FOOTER -->
	<footer class="mt-4 pt-5 pb-3 bg-dark-1 text-white">
		<div class="container">
