	  		...
	  		<div class="form-cadastro">
		  		<form action="../Autentica_Cadastro" method="post">		
				  	...
				  	<div class="inputs">
				  		<div class="row input">
				  			<div class="col-sm">
				  				<input type="text" class="nome" name="nome" id="nome" placeholder="Insira seu nome" required>		  			
				  			</div>
				  			<div class="col-sm">
				  				<input type="text" class="sobrenome" name="sobrenome" id="sobrenome" placeholder="Insira seu sobrenome" required>		  			
				  			</div>		  		
				  		</div>
				  		<div class="input">
				  			<input type="tel" class="telefone" name="telefone" id="telefone" placeholder="Insira seu telefone: (xx) x xxxx-xxxx" required>
				  		</div>
				  		<div class="input">
				  			<input type="email" class="email" name="email" id="email" placeholder="Insira seu email: exemplo@provedor.com" required>
				  		</div>
				  		<div class="input">
				  			<input type="password" class="senha" name="senha" id="senha" placeholder="Insira sua senha" required>	
				  		</div>
				  		<input type="submit" value="Cadastrar" class="btn-dark btn-cadastro"> 			
				  	</div>
		  		</form>
	  		</div>
	  	</section>
