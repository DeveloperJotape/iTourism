...
<body>
  ...
  <!-- FOMULARIO DE LOGIN -->
  <div class="container">
  	<form action="Autenticar-entrar.jsp" method="post" class="justify-content-center d-flex text-center"> 		
    	<div class="login">
    		<div class="image-form">
  				<img src="../images/login.svg">
  			</div>
		    	<input type="text" name="input-box-text-default login" id="name" placeholder="Insira o nome de usuário" autofocus required>
		        <input type="password" name=input-box-text-defaultpassword" id="password" placeholder="Insira a senha" required>		        
		        <input type="submit" value="Entrar">
	        <p>Ainda não possui uma conta? <br><a href="#">Criar conta</a></p>
	    </div>
    </form>
  </div>  
